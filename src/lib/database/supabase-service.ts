...
const SUPABASE_SERVICE_KEY = process.env.SUPABASE_SERVICE_KEY || 'demo-service-key';
    ...
    return [
      {
        ...
        description: 'From the hills of Tuscany, Nonna Lucia brings generations of authentic Italian cooking to your kitchen.',
        personality_traits: ['warm', 'patient', 'storytelling', 'traditional', 'nurturing'],
        signature_dish: 'Homemade Pasta with Bolognese',
      ...
      },
      {
        ...
        description: 'With recipes passed down through her family in Valencia, Abuela Rosa shares the warmth of Spanish cuisine.',
        personality_traits: ['energetic', 'passionate', 'cultural', 'spicy', 'festive'],
        signature_dish: 'Paella Valenciana',
      ...
      },
      {
        ...
        name: 'Mae Malai',
        cuisine_type: 'thai',
        description: 'From the bustling markets of Bangkok, Mae Malai brings the authentic flavors of Thailand to your table.',
        personality_traits: ['precise', 'mindful', 'seasonal', 'minimalist', 'respectful'],
        signature_dish: 'Pad Thai with Tamarind',
